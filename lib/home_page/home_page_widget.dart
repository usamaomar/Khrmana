                        ...
                        child: Builder(
                          builder: (context) {
                            final list = List.generate(
                                random_data.randomInteger(2, 15),
                                                    ...
                                                    child: Opacity(
                                                      ...
                                                      child: Align(
                                                        ...
                                                        child: Stack(
                                                          children: [
                                                            Image.network(
                                                              'https://www.aljazeera.net/wp-content/uploads/2019/08/6ceb6ad0-89ad-40f3-ae76-ffa88498caef.jpeg',
                                                              width: double
                                                                  .infinity,
                                                              height: 135.0,
                                                              fit: BoxFit.cover,
                          ...
                          builder: (context) {
                            ...
                            return SingleChildScrollView(
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children:
                                    List.generate(list2.length, (list2Index) {
